import { PublicLandingRebuildV2 } from "../components/public-landing-rebuild-v2";
...
function publicJob(job: ApiJob) {
  return {
    ...
    companySlug: job.organisationName.toLowerCase().replace(/[^a-z0-9]+/g, "-"),
    title: job.title,
    tags: job.skills,
    ...
    mark: job.organisationName.slice(0, 1),
    tone: "blue",
  };
}
...
export default async function HomePage() {
  ...
  return <PublicLandingRebuildV2 jobs={jobs?.content.map(publicJob)} articles={articles ?? undefined} />;
}
