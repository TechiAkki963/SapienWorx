...
export async function POST(request: Request) {
  let body: { candidateId?: unknown; contactMethod?: unknown; purpose?: unknown };
  ...
  if (!Number.isInteger(body.candidateId) || !["email", "phone"].includes(String(body.contactMethod)) || body.purpose !== "recruitment_pipeline") {
