          ...
          <aside className="lg:sticky lg:top-24 lg:self-start">
            <Surface className="p-5">
              ...
              <form className="mt-5 grid gap-4" action="/jobs">
                ...
                {(q || location || workMode) && <Button href="/jobs" variant="ghost">Clear filters</Button>}
              </form>
            </Surface>
          </aside>
