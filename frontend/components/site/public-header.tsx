    ...
    <header className="sticky top-0 z-50 border-b border-white/60 bg-white/95 backdrop-blur-xl supports-[backdrop-filter]:bg-white/92">
      <Container className="flex min-h-[64px] items-center justify-between gap-3 py-2 sm:min-h-[72px] sm:gap-4 sm:py-3">
        ...
        <div className="flex items-center gap-1.5 sm:gap-2">
          <Link className="hidden min-h-10 items-center justify-center rounded-full border border-indigo/35 bg-white px-4 text-sm font-bold text-navy transition hover:border-indigo hover:bg-indigo-soft xl:inline-flex" href="/recruiter/login">For Recruiters <span className="ml-1.5" aria-hidden="true">→</span></Link>
          {session ? (
            ...
            <div className="hidden items-center gap-2 sm:flex">
              <Button href="/login" variant="ghost" size="sm" className="hidden whitespace-nowrap xl:inline-flex">Log in</Button>
